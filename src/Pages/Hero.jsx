...
const Hero = () => {
  ...
  return (
    <React.Fragment>
      ...
      {/* <div className="video-background w-[100%] h-[100vh]flex justify-center items-center">
        <video autoPlay loop muted className="video-container">
          <source src="/background-video.mp4" type="video/mp4" />
          Your browser does not support the video tag.
        </video>
        <div className="w-[90%] h-[80vh] flex justify-center items-center rounded shadow-md">
          <div className="w-[90%] md:w-[80%] xl:w-[70%] mx-auto py-5">
            <div className="w-[100%] grid gap-1 mb-8">
              <p className="text-lg text-center text-[#265670] font-semibold font-[Urbanist]">
                Project Topic:
              </p>
              <p className=" text-7xl text-center text-black capitalize font-semibold font-[Urbanist]">
                <Typewriter
                  words={["pre order binary tree depth first search"]}
                  loop={1}
                  cursor
            ...
            <div className="w-[100%] grid gap-1 mb-8">
              ...
              <p className="text-3xl text-center text-black capitalize font-medium font-[Urbanist]">
                {firstDone && (
                  <Typewriter
                    words={["Group 9"]}
                    loop={1}
            ...
            <div className="w-[100%] grid gap-1">
              <p className="text-lg text-center text-[#265670] font-semibold font-[Urbanist]">
                Lecturer:
              </p>
              <p className="text-3xl text-center text-black capitalize font-medium font-[Urbanist]">
